...
pub fn secret(p: u64, pub_key: u64, private_key: u64) -> u64 {
    mod_exp(pub_key, private_key, p)
}
...
#[cfg(test)]
mod test {
    use crate::diffie_hellman::{mod_exp, private_key, public_key, secret};

    #[test]
    fn mod_exp_test() {
        let output = mod_exp(4, 13, 497);
